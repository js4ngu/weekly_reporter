...
class ReportTab:
    ...
    def _build_ui(self):
        ...
        self.edit_btn = tk.Button(btns_frame, text="보고서 수정", command=self.load_for_edit, state='disabled')
        self.edit_btn.pack(fill="x", pady=(6,0))
        ...
        self.date_entry = DateEntry(self.input_frame, width=20, 
    ...
    def set_date(self, date):
        ...
        self.date_entry.set_date(datetime.datetime.strptime(date, "%Y-%m-%d").date())
